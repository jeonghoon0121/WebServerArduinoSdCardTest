    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("</head>");
          client.println("<body>");
          client.println("<header><h1>Welcome to Arduino Web Server</h1></header>");
          client.println("<main>");
          client.println("<p>This page is served directly from your Arduino!</p>");
          client.println("<p>Feel free to customize this HTML content.</p>");
          client.println("<button onclick=\"alert('Hello from Arduino!')\">Click Me</button>");
          client.println("</main>");
          client.println("<footer>&copy; 2025 JeongHoon's Arduino Server</footer>");
          client.println("</body>");
          client.println("</html>");
